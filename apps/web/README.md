...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/xp-technologies-dev/p-stream)
...
| Frontend      | [P-Stream](https://p-stream.github.io/docs/instances)  | [source code](https://github.com/xp-technologies-dev/p-stream)     |
...
```bash
git clone https://github.com/xp-technologies-dev/p-stream.git
cd p-stream
git pull
pnpm install
pnpm run dev
...
```bash
git remote add upstream https://github.com/xp-technologies-dev/p-stream.git
